...
Route::get('/red_prod/{id}',[CatController::class,'red_prod']);
Route::get('/rem_prod/{id}',[CatController::class,'rem_prod']);
Route::post('/red_prod_res',[CatController::class,'red_prod_res']);

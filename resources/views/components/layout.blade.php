...
<head>
    ...
    <meta name="description" content="Culinary Oasis - ваше место назначения для безупречно приготовленных блюд с доставкой прямо к вам домой. Наслаждайтесь широким ассортиментом изысканных блюд различных кухонь мира, каждое из которых приготовлено с любовью и профессионализмом наших шеф-поваров." />
    <link rel="icon" type="image/x-icon" href="/Images/browser.png">
     <link rel="stylesheet" href="/css/bootstrap.css">
     <script src="js/jquery.js"></script>
    <title>Culinary Oasis</title>
    <style>
      @font-face {
        font-family: 'Cic';
